    ...
    <div id="pagina">
        ...
        <h2 class="form__titulo">
            <img src="http://notariosatinet.com.mx/utilerias_appliweb/LogoAtinetSinFondo.png" class="img1" alt="atinet"
                width="80" height="auto" align="center">
            <img src="logo-notario.jpg" class="img1" alt="atinet" width="250" align="center">

        </h2>
        <form action="src/registrar.php" method="post" class="form-register">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            ...
                            <div class="grid_3Comp">
                                ...
                                <select name="pais" id="pais_1" placeholder="País" class="input3 inputGrid4_Tres"> <?php
                                    $query = $conexion2->query("SELECT * FROM catpaises");
                                    while ($valores = mysqli_fetch_array($query)) {
                                        echo '<option value="' . $valores['Nombre'] . '">' . $valores['Nombre'] . '</option>';
                                    }
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            ...
                            <div class="grid_1Comp">
                                <label id="autoridad_emisora_texto" class="inputGrid1_Text">Autoridad
                                    Emisora</label>
